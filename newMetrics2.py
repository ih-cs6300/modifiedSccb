...
#changed this line to give per crown metrics rather than per pixel metrics
full_data = df.merge(yobs.groupby(['itcID']).first().reset_index(), left_on="crown", right_on="itcID")
